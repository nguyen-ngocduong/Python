...
class Score:
    def __init__(self,diem_quatrinh, diem_thuchanh, diem_cuoiky):
        ...
        self.diem_tbm = self.diem_quatrinh * 0.2 + self.diem_thuchanh * 0.3 + self.diem_cuoiky * 0.5
        if self.diem_tbm >= 5:
...
def add_student():
    ...
    student = Student(name, gender, age, diem_toan, diem_van, diem_anh,diem_ly,diem_hoa)
